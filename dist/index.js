const r = (s) => s, e = /(?:\d+d\d+)(?:r|rr|x|xo|kh|kl|dh|dl|min|max|even|odd|cs|cf)?(?:>=|<=|>|<|=)?\d*/gim, a = (s) => {
  let d = { original: s, parsed: s, wasSuccessful: !0, matches: [], results: [] };
  try {
    return d.matches = s.match(e) || [], d = r(d), d;
  } catch (c) {
